/* COMPILE WITH: c++ 01_Class_Date.cpp -o 01_Class_Date -Wall -Wextra -g -std=c++14
   DEBUG WITH: gdb ./01_Class_Date core; (gdb) r; (gdb) quit;
   TEST WITH: g++ -g -fsanitize=address 01_Class_Date.cpp -o 01_Class_Date; ./01_Class_Date.cpp;
